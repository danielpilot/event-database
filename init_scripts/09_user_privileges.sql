...
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA events TO event_user;
...
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA statistics TO log_user;

GRANT ALL PRIVILEGES ON SCHEMA logs TO log_user;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA logs TO log_user;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA logs TO log_user;
